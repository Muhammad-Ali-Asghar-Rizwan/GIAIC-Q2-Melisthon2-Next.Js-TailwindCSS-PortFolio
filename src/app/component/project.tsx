              ...
              <div className="flex relative">
                ...
                <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100">
                  ...
                  <p className="leading-relaxed">
                    An advanced CV/Resume Builder tool that enables users to
                    create and customize professional CVs/Resumes with ease.
                  </p>
                  <Link
            ...
            <div className="lg:w-1/3 sm:w-1/2 p-4">
              <div className="flex relative">
                ...
                <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100">
                  ...
                  <p className="leading-relaxed">
                    A simple and accurate digital clock displaying the current
                    time, built using [technology used].
                  </p>
                  <Link
            ...
            <div className="lg:w-1/3 sm:w-1/2 p-4">
              <div className="flex relative">
                ...
                <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100">
                  ...
                  <p className="leading-relaxed">
                    A showcase of my projects, skills, and experiences that
              ...
              <div className="flex relative">
                ...
                <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100">
                  ...
                  <p className="leading-relaxed">
                    ...
                    arithmetic operations, allowing users to easily calculate
                    numbers.
                  </p>
                  <Link
            ...
            <div className="lg:w-1/3 sm:w-1/2 p-4">
              <div className="flex relative">
                ...
                <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100">
                  ...
                  <p className="leading-relaxed">
                    A classic and engaging Tic Tac Toe game built with
                    [technology used], allowing two players to compete against
                    each other.
                  </p>
                  <Link
              ...
              <div className="flex relative">
                ...
                <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100">
                  ...
                  <p className="leading-relaxed">
                    ...
                    calculates a user&apos;s age based on their birth date and
                    current date.
                  </p>
                  <Link
