        ...
        <div className="flex relative">
          ...
          <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100">
            ...
            <p className="leading-relaxed">
              An advanced CV/Resume Builder tool that enables users to create
              and customize professional CVs/Resumes with ease.
            </p>
            <Link
      ...
      <div className="lg:w-1/3 sm:w-1/2 p-4">
        <div className="flex relative">
          ...
          <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100">
            ...
            <p className="leading-relaxed">
              A simple and accurate digital clock displaying the current time,
              built using [technology used].
            </p>
            <Link
      ...
      <div className="lg:w-1/3 sm:w-1/2 p-4">
        <div className="flex relative">
          ...
          <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100">
            ...
            <p className="leading-relaxed">
              A showcase of my projects, skills, and experiences that highlight
      ...
      <div className="lg:w-1/3 sm:w-1/2 p-4">
        <div className="flex relative">
          ...
          <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100">
            ...
            <p className="leading-relaxed">
              A basic and intuitive calculator application that performs
              arithmetic operations, allowing users to easily calculate numbers.
            </p>
            <Link
      ...
      <div className="lg:w-1/3 sm:w-1/2 p-4">
        <div className="flex relative">
          ...
          <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100">
            ...
            <p className="leading-relaxed">
              A classic and engaging Tic Tac Toe game built with [technology
              used], allowing two players to compete against each other. The
              game features a simple and intuitive interface, ensuring a
      ...
      <div className="lg:w-1/3 sm:w-1/2 p-4">
        <div className="flex relative">
          ...
          <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100">
            ...
            <p className="leading-relaxed">
              A simple and interactive Age Calculator application that
              calculates a user&apos;s age based on their birth date and current
              date. It features a user-friendly interface and accurate
              calculations.
            </p>
            <Link
